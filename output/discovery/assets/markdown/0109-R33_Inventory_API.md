---
title: "R33_Inventory_API.json"
url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/R33/R33_Inventory_API.json"
final_url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/R33/R33_Inventory_API.json"
content_type: "application/json"
classification: "json_asset"
fetched_at: "2026-04-10T01:56:06+00:00"
---

# R33_Inventory_API.json
...
```json
{
  ...
  "info": {
    "version": "",
    "title": "Coupa API",
    "description": "RESTful API that provides robust access to read, edit, or integrate your data with the Coupa platform. The [JSON](/api_docs/4.json) and [YAML](/api_docs/4.yaml) are also available.  To test with OAuth2 OAuth2AccessCode, make sure to include https://invoicing-master-minus-one-qe2.coupadev.com/oauth2-redirect.html in the client's Redirect URI list"
  },
  "host": "invoicing-master-minus-one-qe2.coupadev.com",
  "basePath": "/api",
  "tags": [
    {
  ...
  "securityDefinitions": {
    "OAuth2ClientCredential": {
      "type": "oauth2",
      "flow": "application",
      "tokenUrl": "https://invoicing-master-minus-one-qe2.coupadev.com/oauth2/access_tokens",
      "scopes": {
        ...
        "core.inventory.pick_list.read": "translation missing: en.scopes.core_inventory_pick_list_read.description",
        "core.inventory.pick_list.write": "translation missing: en.scopes.core_inventory_pick_list_write.description"
      }
    },
    "OAuth2AccessCode": {
      "type": "oauth2",
      "flow": "accessCode",
      "authorizationUrl": "https://invoicing-master-minus-one-qe2.coupadev.com/oauth2/authorizations/new",
      "tokenUrl": "https://invoicing-master-minus-one-qe2.coupadev.com/oauth2/token",
      "scopes": {
        "core.inventory.common.read": "Allows to view inventory set up entities",
        "core.inventory.common.write": "Allows to modify inventory set up entities",
        "core.inventory.cycle_counts.read": "Allows cycle counts to be read",
  ...
  "definitions": {
    ...
    "Contract": {
      ...
      "properties": {
        ...
        "diversity-categories": {
          "type": "string",
          "description": "Supplier Diversity categories",
          "format": "string",
          "readOnly": true
        },
        "end-date": {
    ...
    "CycleCountLine": {
      ...
      "properties": {
        ...
        "cycle-count-line-adjustments": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/CycleCountLineAdjustment"
          }
        },
    ...
    "Payables-Invoice": {
      ...
      "properties": {
        ...
        "payment-term": {
          "type": "string",
          "description": "Payment term of the invoice header",
          "format": "string",
          "readOnly": true
        },
    ...
    "SupplierInformationAddress": {
      ...
      "properties": {
        ...
        "supplier-information-tax-registrations": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/SupplierInformationTaxRegistration"
          }
        },
        "swift-code": {
          "type": "string",
    ...
    "SupplierInformationTaxRegistration": {
      "type": "object",
      "properties": {
        "active": {
          "type": "boolean",
          "description": "Tax Registration Status",
          "format": "boolean"
        },
        "country": {
          "$ref": "#/definitions/Country"
        ...
        "supplier-information-id": {
          "type": "integer",
          "description": "Supplier Information ID",
          "format": "integer"
        },
        "updated-at": {
          "type": "string",
