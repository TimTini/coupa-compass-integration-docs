---
title: "R38_Worker_Management_API.json"
url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/R38/R38_Worker_Management_API.json"
final_url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/R38/R38_Worker_Management_API.json"
content_type: "application/json"
classification: "json_asset"
fetched_at: "2026-04-10T01:56:22+00:00"
---

# R38_Worker_Management_API.json
...
```json
{
  ...
  "info": {
    "version": "",
    "title": "Coupa API",
    "description": "RESTful API that provides robust access to read, edit, or integrate your data with the Coupa platform. The [JSON](/api_docs/33.json) and [YAML](/api_docs/33.yaml) are also available.  To test with OAuth2 OAuth2AccessCode, make sure to include https://r38.coupadev.com/oauth2-redirect.html in the client's Redirect URI list"
  },
  ...
  "paths": {
    "/services_procurement/job_levels": {
      "get": {
        "tags": [
          "JobLevel"
        ],
        "summary": "/services_procurement/job_levels",
        "description": "",
        "produces": [
          "application/xml",
          "application/json"
    ...
    "/services_procurement/job_levels/{id}": {
      "get": {
        "tags": [
          "JobLevel"
        ],
        "summary": "/services_procurement/job_levels/{id}",
        "description": "",
        "produces": [
          "application/xml",
          "application/json"
    ...
    "/services_procurement/job_categories": {
      "get": {
        "tags": [
          "JobCategory"
        ],
        "summary": "/services_procurement/job_categories",
        "description": "",
        "produces": [
          "application/xml",
          "application/json"
        ...
        "responses": {
          "200": {
            "description": "JobCategory objects",
            "schema": {
              "type": "array",
              "items": {
    ...
    "/services_procurement/job_categories/{id}": {
      "get": {
        "tags": [
          "JobCategory"
        ],
        "summary": "/services_procurement/job_categories/{id}",
        "description": "",
        "produces": [
          "application/xml",
          "application/json"
    ...
    "/services_procurement/job_titles/{id}/toggle_active": {
      "post": {
        "tags": [
          "JobTitle"
        ],
        "summary": "/services_procurement/job_titles/{id}/toggle_active",
        "description": "",
        "consumes": [
          "application/xml",
          "application/json"
    ...
    "/services_procurement/job_titles": {
      "get": {
        "tags": [
          "JobTitle"
        ],
        "summary": "/services_procurement/job_titles",
        "description": "",
        "produces": [
          "application/xml",
          "application/json"
    ...
    "/services_procurement/job_titles/{id}": {
      "get": {
        "tags": [
          "JobTitle"
        ],
        "summary": "/services_procurement/job_titles/{id}",
        "description": "",
        "produces": [
          "application/xml",
          "application/json"
  ...
  "securityDefinitions": {
    "OAuth2ClientCredential": {
      ...
      "scopes": {
        "core.services_procurement.job_categories.read": "Allows Job Categories to be read",
        "core.services_procurement.job_categories.write": "Allows Job Categories to be modified",
        "core.services_procurement.job_levels.read": "Allows Job Levels to be read",
        "core.services_procurement.job_levels.write": "Allows Job Levels to be modified",
        "core.services_procurement.job_titles.read": "Allows Job Titles to be read",
        "core.services_procurement.job_titles.write": "Allows Job Titles to be modified"
      }
    },
    "OAuth2AccessCode": {
      "type": "oauth2",
