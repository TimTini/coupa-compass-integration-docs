---
title: "Forms (Easy Forms) Import"
url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/coupa-core-flat-files-(csv)/flat-file-(csv)-import/forms-(easy-forms)-import"
final_url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/coupa-core-flat-files-(csv)/flat-file-(csv)-import/forms-(easy-forms)-import"
status_code: 200
...
The Forms import process reads files from `./Incoming/EasyForm/` in the
SFTP. These files will be moved to the archive folder located at
`./Incoming/Archive/EasyForm/` before being processed in alphanumeric
order.
...
Type
invoice, invoice_line, supplier_information, sim_remit-to, sim_contract,
contingent_worker, contract, expense_preapproval, supplier_review, user, sourcing
...
| Type* | The type of the design element.<br>Note<br>If a form includes a page break widget, there must be a page break widget in the first widget position. This widget cannot be moved or deleted.<br>All widgets displayed below the page break widget until the next page break widget are associated with that page. | false | true | false | string(255) | header, descriptive_text, section_break, new_line, page_break |
...
The `Type` column for the Object field can contain different values based on
