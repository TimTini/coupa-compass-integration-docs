---
title: "TTContract Interest and Repayment Plan Import"
url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/treasury-integrations/treasury-csv-format-descriptions-(classic)/ttcontract-interest-and-repayment-plan-import"
final_url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/treasury-integrations/treasury-csv-format-descriptions-(classic)/ttcontract-interest-and-repayment-plan-import"
status_code: 200
...
[PDF Version](https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/treasury_integrations/misc/TTContract_Interest_and_Repayment_Plan_Import.pdf)
...
under Special Functions on Treasury > Financial Instruments > Long-term
Loans.

![](https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/treasury_integrations/images/image17.png)

The import function processes files in
...
Use the Loan Identification dropdown to choose whether field 1 selects the deal ID or
the Loan Number.

For each loan, the file must contain the whole repayment plan. Each
imported data set overwrites any existing data sets.

If the file contains data about
multiple loans, the data for each loan must be grouped into a single block.

All cash
flows for the same loan must be in chronological order.
