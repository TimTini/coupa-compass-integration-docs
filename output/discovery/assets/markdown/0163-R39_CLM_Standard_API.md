---
title: "R39_CLM_Standard_API.json"
url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/R39/R39_CLM_Standard_API.json"
final_url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/R39/R39_CLM_Standard_API.json"
content_type: "application/json"
classification: "json_asset"
fetched_at: "2026-04-10T01:56:22+00:00"
---

# R39_CLM_Standard_API.json
...
```json
{
  ...
  "info": {
    "version": "",
    "title": "Coupa API",
    "description": "RESTful API that provides robust access to read, edit, or integrate your data with the Coupa platform. The [JSON](/api_docs/5.json) and [YAML](/api_docs/5.yaml) are also available.  To test with OAuth2 OAuth2AccessCode, make sure to include https://r39.coupadev.com/oauth2-redirect.html in the client's Redirect URI list"
  },
  ...
  "securityDefinitions": {
    "OAuth2ClientCredential": {
      ...
      "scopes": {
        ...
        "core.contracts_template.read": "Allows contracts templates to be read",
        "core.contracts_template.write": "Allows contracts templates to be modified"
      }
    },
    "OAuth2AccessCode": {
      "type": "oauth2",
  ...
  "definitions": {
    ...
    "ContractTemplate": {
      ...
      "properties": {
        ...
        "ccc-id": {
          "type": "string",
          "description": "Identifier for the CCC",
          "format": "string(255)",
          "readOnly": true
        },
        "content-groups": {
        ...
        "contract-hierarchy-types": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/ContractHierarchyType"
          }
        },
        "contract-template-clauses": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/ContractTemplateClause"
          }
        },
        "contract-types": {
          "type": "array",
        ...
        "obsolete-clauses-count": {
          "type": "integer",
          "description": "Obsolete Clauses Count on Template",
          "format": "integer",
          "readOnly": true
        },
        "source": {
          "type": "string",
          "description": "Identifier for Contract Template Source",
          "format": "string(255)"
        },
        "supporting-document": {
          "type": "boolean",
        ...
        "template-generator-type": {
          "type": "integer",
          "description": "Template Generator Type",
          "format": "integer",
          "readOnly": true
        },
        "updated-at": {
    ...
    "LegalDocument": {
      "type": "object",
      "properties": {
        "ccc-exec-summary-timestamp": {
          "type": "string",
          "description": "Executive Summary updated at timestamp from ccc used to see if document is latest",
          "format": "datetime",
          "enum": [
        ...
        "ccc-file-timestamp": {
          "type": "string",
          "description": "Legal document updated at timestamp from ccc used to see if document is latest",
          "format": "datetime",
          "enum": [
            "YYYY-MM-DDTHH:MM:SS+HH:MM"
          ]
