---
title: "Requisition Amount Line API"
url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-coupa-core-api/resources/transactional-resources/requisitions-api-(requisitions)/requisition-amount-line-api"
final_url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-coupa-core-api/resources/transactional-resources/requisitions-api-(requisitions)/requisition-amount-line-api"
status_code: 200
...
This resource is associated with [Requisition Line API](https://compass.coupa.com/x286205.xml).

## Elements

The following elements are available for the Requisition Amount
Line API:
...
| confirm_by_hrs | Confirm by hours | | | 0..87600 | yes | | decimal(10,0) |
| order_confirmation_level | Order confimation level | | | | yes | | integer |
