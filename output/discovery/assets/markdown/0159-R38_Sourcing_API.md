---
title: "R38_Sourcing_API.json"
url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/R38/R38_Sourcing_API.json"
final_url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/R38/R38_Sourcing_API.json"
content_type: "application/json"
classification: "json_asset"
fetched_at: "2026-04-10T01:56:22+00:00"
---

# R38_Sourcing_API.json
...
```json
{
  ...
  "info": {
    "version": "",
    "title": "Coupa API",
    "description": "RESTful API that provides robust access to read, edit, or integrate your data with the Coupa platform. The [JSON](/api_docs/3.json) and [YAML](/api_docs/3.yaml) are also available.  To test with OAuth2 OAuth2AccessCode, make sure to include https://r38.coupadev.com/oauth2-redirect.html in the client's Redirect URI list"
  },
  ...
  "definitions": {
    ...
    "EasyForm": {
      ...
      "properties": {
        ...
        "warnings": {
          ...
          "format": "#<Warnings::WarningMessages:0x00007f50794752e0>",
          "readOnly": true
        }
      },
      "required": [
    ...
    "Lookup": {
      ...
      "properties": {
        ...
        "values-count": {
          "type": "integer",
          "description": "Total count of lookup values for this lookup",
          "format": "integer",
          "readOnly": true
        }
      },
    ...
    "LookupValue": {
      ...
      "properties": {
        ...
        "children-count": {
          "type": "integer",
          "description": "Total count of children for this lookup value",
          "format": "integer",
          "readOnly": true
        },
        "created-at": {
    ...
    "QuoteRequest": {
      ...
      "properties": {
        ...
        "allow-supplier-to-send-attachments": {
          "type": "boolean",
          "description": "If set to true by the buyer, the supplier is allowed to send attachments in the message center",
          "format": "boolean"
        },
        "attachments": {
          "type": "array",
