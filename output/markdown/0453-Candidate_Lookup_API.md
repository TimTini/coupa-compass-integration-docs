---
title: "Candidate Lookup API"
url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-ccw-api/candidate-lookup-api"
final_url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-ccw-api/candidate-lookup-api"
status_code: 200
...
The base URL to access the CCW Candidate Lookup API is: `https:///api/candidates/search`

Refer to the [CCW API Overview](https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-ccw-api/ccw-api-overview) to learn how to authenticate and submit POST requests to CCW APIs. Requests should include the following elements:

## Request Headers

Request headers are required for authentication purposes. See [Request Headers](https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-ccw-api/ccw-api-overview#request_headers-d26e3746) section of CCW's API Overview documentation for details.
...
The Data section includes one or more specific lookup parameters to be requested (at least one non-empty parameter must be sent).
...
| status | string(50) | No | No | One of CCW's valid statuses | See [Valid Candidate Statuses](https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-ccw-api/candidate-lookup-api#valid_candidate_statuses) table below. |
...
| onboarding_eligibility_met | number | No | No | 0,1 | 0=eligible, 1=not eligible |
...
| status | data | string(50) | See [Valid Candidate Statuses](https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-ccw-api/candidate-lookup-api#valid_candidate_statuses) table below. |
...
| onboarding_eligibility_met | data | boolean | 0=eligible, 1=not eligible |
...
| type | data.requisition | string(200) | Requisition type (for example: identified candidate, regular) |
