---
title: "R39_Purchasing_API.json"
url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/R39/R39_Purchasing_API.json"
final_url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/R39/R39_Purchasing_API.json"
content_type: "application/json"
classification: "json_asset"
fetched_at: "2026-04-10T01:56:24+00:00"
---

# R39_Purchasing_API.json
...
```json
{
  ...
  "info": {
    "version": "",
    "title": "Coupa API",
    "description": "RESTful API that provides robust access to read, edit, or integrate your data with the Coupa platform. The [JSON](/api_docs/1.json) and [YAML](/api_docs/1.yaml) are also available.  To test with OAuth2 OAuth2AccessCode, make sure to include https://r39.coupadev.com/oauth2-redirect.html in the client's Redirect URI list"
  },
  ...
  "tags": [
    ...
    {
      "name": "Payables-Order",
      "description": "Payable Order API"
    },
    {
      "name": "Payables-Order-ReconciliationLine",
      "description": ""
    },
    {
  ...
  "paths": {
    ...
    "/order_pads/{order_pad_id}/order_pad_lines/{id}": {
      ...
      "delete": {
        ...
        "summary": "Delete order pad line",
        "description": "Delete order pad line",
        "produces": [
          "application/xml",
          "application/json"
        ],
    ...
    "/order_pads/{id}": {
      ...
      "delete": {
        ...
        "summary": "Delete order pad",
        "description": "Delete order pad",
        "produces": [
          "application/xml",
          "application/json"
        ],
    ...
    "/items/{item_id}/supplier_items/{id}": {
      ...
      "delete": {
        ...
        "description": "Delete supplier item",
        "produces": [
          "application/xml",
          "application/json"
        ],
    ...
    "/payables/orders/{id}/ready_to_pay": {
      "patch": {
        "tags": [
          "Payables-Order"
        ],
        "summary": "Mark Order as Ready to Pay",
        "description": "Mark Order as Ready to Pay",
        "consumes": [
          "application/xml",
          "application/json"
        ],
        ...
        "responses": {
          "200": {
            "description": "Payables-Order object",
            "schema": {
              "items": {
                "$ref": "#/definitions/Payables-Order"
              }
    ...
    "/payables/orders/{id}/pay_externally": {
      "patch": {
        "tags": [
          "Payables-Order"
        ],
        "summary": "Mark Order as Paid Externally",
        "description": "Mark Order as Paid Externally",
        "consumes": [
          "application/xml",
          "application/json"
        ],
    ...
    "/payables/orders": {
      "get": {
        ...
        "responses": {
          "200": {
            "description": "Payables-Order objects",
            "schema": {
              "type": "array",
              "items": {
                "$ref": "#/definitions/Payables-Order"
    ...
    "/payables/order/reconciliation_lines": {
      "get": {
        ...
        "summary": "/payables/order/reconciliation_lines",
        "description": "",
        "produces": [
          "application/xml",
          "application/json"
        ...
        "responses": {
          "200": {
            "description": "Payables-Order-ReconciliationLine objects",
            "schema": {
              "type": "array",
              "items": {
              ...
              "xml": {
                "name": "payables-order-reconciliation-lines",
                "wrapped": true
              }
            }
          },
    ...
    "/payables/order/reconciliation_lines/{id}": {
      "get": {
        "tags": [
          "Payables-Order-ReconciliationLine"
        ],
        "summary": "/payables/order/reconciliation_lines/{id}",
        "description": "",
        "produces": [
          "application/xml",
          "application/json"
        ...
        "responses": {
          "200": {
            "description": "Payables-Order-ReconciliationLine object",
            "schema": {
              "$ref": "#/definitions/Payables-Order-ReconciliationLine"
            }
          },
    ...
    "/asset_tags": {
      "get": {
        ...
        "summary": "Query asset tags",
        "description": "Query asset tags",
        "produces": [
          "application/xml",
          "application/json"
        ],
    ...
    "/asset_tags/{id}": {
      "get": {
        ...
        "summary": "Show asset tag",
        "description": "Show asset tag",
        "produces": [
          "application/xml",
          "application/json"
        ],
  ...
  "securityDefinitions": {
    "OAuth2ClientCredential": {
      ...
      "scopes": {
        "core.catalog.read": "Allows catalog items to be read",
        "core.catalog.write": "Allows catalog items to be modified",
        "core.contract.read": "Allows contracts to be read",
        "core.contract.write": "Allows contracts to be modified",
        "core.inventory.asn.read": "Allows to read advance shipment notices (ASN)",
        "core.inventory.asn.write": "Allows to create/modify advance shipment notices (ASN)",
        "core.inventory.balance.read": "Allows to view inventory on hand balances",
        "core.inventory.common.write": "Allows to modify inventory set up entities",
        "core.inventory.transaction.read": "Allows to view inventory transactions",
        "core.invoice.read": "Allows to view invoices",
        "core.order_pad.read": "Allows to view order pads",
        "core.order_pad.write": "Allows to create or modify order pads",
        "core.payables.order.read": "Allows Pay Orders to be read",
        "core.payables.order.write": "Allows Pay Orders to be updated",
        "core.purchase_order.read": "Allows to view purchase orders",
        "core.purchase_order.write": "Allows to create or modify purchase orders",
        "core.requisition.read": "Allows to view requsitions",
        "core.requisition.write": "Allows to create or modify requisitions"
      }
    },
    "OAuth2AccessCode": {
      "type": "oauth2",
  ...
  "definitions": {
    ...
    "OrderHeaderChange": {
      ...
      "properties": {
        ...
        "lines-count": {
          "type": "integer",
          "description": "Number of lines in the PO Change document",
          "format": "integer",
          "readOnly": true
        },
        "lines-pending-add-count": {
          "type": "integer",
          "description": "Number of lines pending addition in PO Change document",
          "format": "integer",
          "readOnly": true
        },
        "lines-pending-delete-count": {
          "type": "integer",
          "description": "Number of lines pending deletion in PO Change document",
          "format": "integer",
          "readOnly": true
        },
        "milestones": {
        ...
        "pending-cancel": {
          "type": "boolean",
          "description": "Is the PO pending cancellation. True or False",
          "format": "boolean",
          "readOnly": true
        },
        "po-number": {
        ...
        "total": {
          "type": "number",
          "description": "PO Change document total",
          "format": "decimal(32,4)",
          "readOnly": true
        },
        "transmission-emails": {
    ...
    "OrderLineChange": {
      ...
      "properties": {
        ...
        "order-line-change-tax-detail": {
          "$ref": "#/definitions/OrderLineChangeTaxDetail"
        },
        "order-line-id": {
          "type": "integer",
          "description": "order_line_id",
    ...
    "OrderPad": {
      ...
      "properties": {
        ...
        "visual-annotations": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/OrderPadVisualAnnotation"
          }
        }
      },
      "required": [
