---
title: "Inventory Transfers API (/inventory_transfers)"
url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-coupa-core-api/resources/transactional-resources/receipts-api/inventory-transfers-api-(inventory_transfers)"
final_url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-coupa-core-api/resources/transactional-resources/receipts-api/inventory-transfers-api-(inventory_transfers)"
status_code: 200
...
is: `https:///api/inventory_transfers`
...
Inventory Transfers allow you to:

| **Verb** | **Path** | **Action** | **Description** |
| --- | --- | --- | --- |
| POST | `/api/inventory_transfers` | create | Create inventory transfers |
| GET | `/api/inventory_transfers` | index | Query inventory transfers |
| GET | `/api/inventory_transfers/:id` | show | Show inventory transfers |
| PATCH | `/api/inventory_transfers/:id` | update | Update inventory transfers export flag only |
| PUT | `/api/inventory_transfers/:id` | update | Update inventory transfers export flag only |

The **Type** payload for `/api/inventory_transfers` includes:
