---
title: "Quote Request Line Import"
url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/coupa-core-flat-files-(csv)/flat-file-(csv)-import/quote-request-line-import"
final_url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/coupa-core-flat-files-(csv)/flat-file-(csv)-import/quote-request-line-import"
status_code: 200
...
The Quote Request Line Import is used on sourcing events. You
can add quote request lines to sourcing events via the UI in the
Details section of the sourcing event. Quote request lines cannot
be loaded via SFTP.

## Keys

- None - quote request lines cannot be updated once loaded. They can be deleted from the
UI.
...
| Ship to Address | No | No | | Ship to Address location code. Must exist in Coupa. | |
| Details | No | No | | Comma-separated list of attachments. Supports file paths (file://filename.pdf), URLs (https://example.com/file.pdf), or plain text notes | |
