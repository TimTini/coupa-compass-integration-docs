---
title: "R21_CSV_Export_Formats.xlsx"
url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/CSV/R21_CSV_Export_Formats.xlsx"
final_url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/CSV/R21_CSV_Export_Formats.xlsx"
content_type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
classification: "xlsx_asset"
fetched_at: "2026-04-10T01:55:00+00:00"
---

# R21_CSV_Export_Formats.xlsx

- Raw file: `assets\raw\0003-R21_CSV_Export_Formats.xlsx`
- Extracted text: `assets\text\0003-R21_CSV_Export_Formats.txt`
...
1	Approval Chain ID	ID of the approval chain this approval is located in	integer(11)	No/No
2	Approval Chain Name	The name of the approval chain	string(255)	No/No
3	Document Number	The document ID that was approved	integer(11)	No/No
4	Document Type	The document type that was approved (requisition, purchase order, etc)	string(255)	No/No
5	Document Status	The document status	string(255)	No/No
6	Approver ID	The user ID that made the approval	integer(11)	No/No
7	Approver Login	The user name that made the approval	string(255)	No/No
8	Approver Role	The role of the approver	string(255)	No/No
9	Delegate	The ID of the delegate approval when there is only a single approval delegate	integer(11)	No/No
10	Delegate Approval Ids	The IDs of all the delegate approvals when there are multiple approval delegates	string(255)	No/No
11	Delegate Approver Names	Names of users who are delegates of the approver on the approval	text	No/No
12	Override Approver	Name of the user who bypassed the approval	string(255)	No/No
13	Approval Date (UTC)	The date the approval occurred	datetime	No/No
14	Position	The position in the approval chain this approval occurred	integer(11)	No/No
15	Approval Method	The method in which this approval occurred	string(255)	No/No
16	Approver Type	How the approval occured (override approval, approval chain approval, etc)	string(255)	No/No
17	Approval Key	The key used to authenticate email approvals	string(100)	No/No
18	Status	The status of the approval (approved, escalated, rejected, etc)	string(50)	No/No
19	Approval Reason	Explains why an approver was added as an approver for the document	text	No/No
20	Document Currency	The currency of the document that was approved	string(6)	No/No
21	Created By ID	The user ID that created the approval	integer(11)	No/No
22	Created By Login	The user login that created the approval	string(255)	No/No
23	Created Date	The date the user create the approval	datetime	No/No
24	Last Updated By ID	The user ID that most recently updated the approval	integer(11)	No/No
25	Updated By Login	Ther user login that most recently updated the approval	string(255)	No/No
26	Last Updated Date	The date the approval was most recently updated	datetime	No/No
27	Owned By ID	The owner of the approval	integer(11)	No/No
28	Owned By Login	The user login that owns the approval	string(255)	No/No
29	Assigned By ID	Who the approval was assigned to	integer(11)	No/No
30	Assigned By Login	The user login that is assigned to the approval	string(255)	No/No
31	Assigned Date	The date the approval was assigned to the user	datetime	No/No
32	First Notification (UTC)	The date the user was first notified that they can approve	datetime	No/No
33	Last Reminded Date	The date the user was last reminded that they can approve	datetime	No/No
34	Skip Escalation	If the approval was a skip escalation (Y/N)	boolean	No/No
35	Submission Date	The date the document was submitted	datetime	No/No
...
Position	Column Name	Description	Type	Req/Unique	Allowable Values
1	Approver ID	The user ID that made the approval	integer(11)	No/No
2	Approver Login	The user login that made the approver	string(255)	No/No
3	Delegate ID	The delegate ID that made the approval (if applicable)	integer(11)	No/No
4	Delegate Login	The delegate login that made the approver	string(255)	No/No
5	Delegation Start Date	The day the delegation period begins	datetime	Yes/No
6	Delegation End Date	The day the delegation period ends	datetime	Yes/No
7	Delegation Reason	The reason for the approval	string(255)	Yes/No
8	Created By ID	The user ID that created the approval delegation	integer(11)	No/No
9	Created By Login	The user login that created the approval delegate	string(255)	No/No
10	Created Date	The date the user create the approval delegation	datetime	No/No
11	Updated By ID	The user ID that most recently updated the approval delegation	integer(11)	No/No
12	Updated By Login	Ther user login that most recently updated the approval delegate	string(255)	No/No
13	Updated Date	The date the approval delegation was most recently updated	datetime	No/No
...
# Sheet: Contracts
Position	Column Name	Description	Type	Req/Unique	Allowable Values
1	Contract #	The contract number	string(50)	Yes/Yes
2	Contract Name	The name of the contract	string(100)	Yes/Yes
3	Content Groups	The content groups that can view this contract	string	No/No
4	Status	The status of the contract	string(50)	Yes/No
5	Supplier	The supplier ID assocaited with the contract	integer(11)	No/No
6	Supplier Number	Supplier Number	string(255)	No/No
7	Supplier Account #	The supplier account for the contract	string(255)	No/No
8	Starts	The date the contract begins	datetime	Yes/No
9	Expires	The date the contract expires	datetime	Yes/No
10	Owner	The currency ID associated with the contract	integer(11)	No/No
11	Owner Login	The user login that owns the contract	string(255)	No/No
12	Currency Code	Currency Code	string(6)	No/No
13	Savings %	The % savings created by the contract	decimal(20,2)	No/No
14	Version	The version number of the contract	integer	No/No
15	Created By	The user ID that created the contract	integer	No/No
16	Created By Login	Created By Login	string(255)	No/No
17	Created Date	The date the contract was created	datetime	No/No
18	Updated By	The user ID that most recently updated the contract	integer(11)	No/No
19	Updated By Login	The user login that most recently updated the contract	string(255)	No/No
20	Updated Date	The date the contract was most recently updated	datetime	No/No
21	Submitted Date	The date the contract was submitted	datetime	No/No
22	Submitted By	The user ID of the person that submitted the contract	integer(11)	No/No
23	Submitted By Login	Ther user login that submitted the approval	string(255)	No/No
24	Is Default	Is this the detault (Y/N)	boolean	No/No
25	Default Account ID	The default account ID for the contract	integer(11)	No/No
26	Default Account Code	The default account code for the contract	string(21024)	No/No
...
23	Account Code	Receipt Account Code	No/No	string(255)	any
...
43	Order Line Price	Order Line Unit Price	No/No	decimal(30,6)	any
...
24	bulk-price	Price of the bulk material	decimal(30,6)	No/No	Any
25	bulk-price-qty	Quantity of the bulk material	decimal(30,6)	No/No	Any
...
# Sheet: Login
Position	Column Name	Description	Type	Req/Unique	Allowable Values
1	User ID	User ID	integer(11)	Yes/No
2	Attempted at	Time attempted to login at	datetime	No/No
3	User Type	User Type	string(255)	No/No
4	User Login	User Login	string(255)	No/No
5	ID	ID	integer(11)	No/No
6	User Agent	User Agent header information when attempted to login	string(255)	No/No
7	Source	Source information when attempted to login	string(255)	No/No
...
18	Primary Address Street2	Primary Address Street2	No/No	string(255)	any
19	Primary Address City	Primary Address City	No/No	string(255)	any
20	Primary Address State	Primary Address State	No/No	string(255)	any
21	Primary Address Postal Code	Primary Address Postal Code	No/No	string(255)	any
...
31	Payment Method	Payment Method	Yes/No	string(255)	invoice, pcard, invoice_only, pcard_only
32	Payment Terms	Payment Terms	No/No	integer(11)	any
33	Shipping Terms	Shipping Terms	No/No	integer(11)	any
34	PO cXML URL	PO cXML URL	Yes/No	string(255)	any
35	PO cXML Domain	PO cXML Domain	Yes/No	string(255)	any
36	PO cXML Identity	PO cXML Identity	Yes/No	string(255)	any
37	PO cXML Supplier Domain	PO cXML Supplier Domain	Yes/No	string(255)	any
38	PO cXML Supplier Identity	PO cXML Supplier Identity	Yes/No	string(255)	any
39	PO cXML Secret	PO cXML Secret	Yes/No	string(940)	any
40	PO cXML Protocol	PO cXML Protocol	Yes/No	string(255)	any
41	Savings (%)	Savings (%)	No/No	decimal(8,2)	any
42	On Hold	On Hold	No/No	boolean	Yes/No, True/False
43	Allow cXML Invoicing	Allow cXML Invoicing	No/No	boolean	Yes/No, True/False
44	cXML Invoicing - Supplier Domain	cXML Invoicing - Supplier Domain	Yes/No	string(255)	any
45	cXML Invoicing - Supplier Identity	cXML Invoicing - Supplier Identity	Yes/Yes	string(255)	any
46	cXML Invoicing - Buyer Domain	cXML Invoicing - Buyer Domain	Yes/No	string(255)	any
47	cXML Invoicing - Buyer Identity	cXML Invoicing - Buyer Identity	Yes/No	string(255)	any
48	cXML Invoicing Shared Key	cXML Invoicing Shared Key	Yes/No	string(255)	any
49	Invoice Emails	Invoice Emails	No/No	string(255)	any
50	Send Invoices To Approvals	Send Invoices To Approvals	No/No	boolean	Yes/No, True/False
51	Allow Invoicing From CSN	Allow Invoicing From CSN	No/No	boolean	Yes/No, True/False
52	Allow Invoicing No Backing Doc From CSN	Allow Invoicing No Backing Doc From CSN	No/No	boolean	Yes/No, True/False
53	custom-field-1	Integration Custom Field 1	No/No	string(255)	any
54	custom-field-2	Integration Custom Field 2	No/No	string(255)	any
55	custom-field-3	Integration Custom Field 3	No/No	string(255)	any
56	custom-field-4	Integration Custom Field 4	No/No	string(255)	any
57	custom-field-5	Integration Custom Field 5	No/No	string(255)	any
58	custom-field-6	Integration Custom Field 6	No/No	string(255)	any
59	custom-field-7	Integration Custom Field 7	No/No	string(255)	any
60	custom-field-8	Integration Custom Field 8	No/No	string(255)	any
61	custom-field-9	Integration Custom Field 9	No/No	string(255)	any
62	custom-field-10	Integration Custom Field 10	No/No	string(255)	any
...
Default Locale	Default Locale	0	0	string(10)	See List of Default Locales
...
Analytics User	Analytics User License?	0	0	boolean	any
custom-field-1	Integration Custom Field 1	0	0	string(255)	any
custom-field-2	Integration Custom Field 2	0	0	string(255)	any
custom-field-3	Integration Custom Field 3	0	0	string(255)	any
custom-field-4	Integration Custom Field 4	0	0	string(255)	any
