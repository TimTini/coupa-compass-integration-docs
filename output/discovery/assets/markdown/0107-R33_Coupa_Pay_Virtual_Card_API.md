---
title: "R33_Coupa_Pay_Virtual_Card_API.json"
url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/R33/R33_Coupa_Pay_Virtual_Card_API.json"
final_url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/R33/R33_Coupa_Pay_Virtual_Card_API.json"
content_type: "application/json"
classification: "json_asset"
fetched_at: "2026-04-10T01:56:05+00:00"
---

# R33_Coupa_Pay_Virtual_Card_API.json
...
```json
{
  ...
  "info": {
    "version": "",
    "title": "Coupa API",
    "description": "RESTful API that provides robust access to read, edit, or integrate your data with the Coupa platform. The [JSON](/api_docs/14.json) and [YAML](/api_docs/14.yaml) are also available.  To test with OAuth2 OAuth2AccessCode, make sure to include https://invoicing-master-minus-one-qe2.coupadev.com/oauth2-redirect.html in the client's Redirect URI list"
  },
  ...
  "tags": [
    {
      "name": "Charge",
      "description": "Charges API"
    },
    {
      "name": "CoupaPay-Statement",
  ...
  "paths": {
    ...
    "/coupa_pay/statements": {
      "get": {
        ...
        "responses": {
          "200": {
            "description": "CoupaPay-Statement objects",
            "schema": {
              "type": "array",
              "items": {
                "$ref": "#/definitions/CoupaPay-Statement"
              },
              "xml": {
                "name": "coupa-pay-statements",
                "wrapped": true
              }
            }
          },
    ...
    "/coupa_pay/statements/{id}": {
      "get": {
        ...
        "responses": {
          "200": {
            "description": "CoupaPay-Statement object",
            "schema": {
              "$ref": "#/definitions/CoupaPay-Statement"
            }
          },
  ...
  "securityDefinitions": {
    "OAuth2ClientCredential": {
      ...
      "scopes": {
        "core.pay.statements.write": "Allows Coupa Pay statements to be modified",
        "core.pay.virtual_cards.read": "Allows Coupa Pay virtual cards to be read"
      }
    },
    "OAuth2AccessCode": {
      "type": "oauth2",
  ...
  "definitions": {
    ...
    "Charge": {
      ...
      "properties": {
        "account-type-id": {
          "type": "integer",
          "description": "Chart of Accounts ID associated with the charge",
          "format": "integer",
          "readOnly": true
        },
        "accounting-currency": {
        ...
        "accounting-total": {
          "type": "number",
          "description": "Amount of charge in Chart Of Accounts Accounting Currency",
          "format": "decimal",
          "readOnly": true
        },
        "card-provider-account": {
          "type": "string",
          "description": "Card Provider Account",
          "format": "string(255)"
        },
        "charge-allocations": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/ChargeAllocation"
          }
        },
        "charge-date": {
          "type": "string",
        ...
        "charge-tax-lines": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/ChargeTaxLine"
          }
        },
        "coupa-pay-id": {
          "type": "integer",
          "description": "Unique Coupa Pay ID",
          "format": "integer"
        },
        "coupa-pay-statement-id": {
          "type": "integer",
          "description": "Unique Coupa Pay Statement ID",
          "format": "integer"
        },
        "created-at": {
          "type": "string",
        ...
        "document-id": {
          "type": "integer",
          "description": "Transactional document ID associated with the charged card",
          "format": "integer",
          "readOnly": true
        },
        "document-type": {
          "type": "string",
          "description": "Type of transactional document associated with the charged card",
          "format": "string",
          "readOnly": true
        },
        ...
        "external-ref-id": {
          "type": "string",
          "description": "Unique 3rd party system ID",
          "format": "string(255)"
        },
        "holding-account": {
          "$ref": "#/definitions/Account"
        ...
        "issuer-reconciliation-id": {
          "type": "string",
          "description": "Issuer Reconciliation ID",
          "format": "string(255)",
          "readOnly": true
        },
        "last-exported-at": {
        ...
        "merchant-reference": {
          "type": "string",
          "description": "Card provided merchant information",
          "format": "string(255)"
        },
        "merchant-total": {
          "type": "number",
          "description": "Total the merchant charged in merchant currency",
          "format": "decimal"
        },
        "order-header-currency": {
          "type": "string",
          "description": "Currency from the charged card's Purchase Order",
          "format": "string",
          "readOnly": true
        },
        "order-header-id": {
          "type": "integer",
          "description": "Purchase Order ID associated with the charged card",
          "format": "integer",
          "readOnly": true
        },
        "order-header-number": {
          "type": "string",
          "description": "Purchase Order Number associated with the charged card",
          "format": "string",
          "readOnly": true
        },
        "order-header-total": {
          "type": "string",
          "description": "Total amount on the charged card's Purchase Order",
          "format": "string",
          "readOnly": true
        },
        "payment-partner": {
        ...
        "posting-date": {
          "type": "string",
          "description": "Date the charge posted",
          "format": "datetime"
        },
        "statement": {
          "$ref": "#/definitions/CoupaPay-Statement"
        ...
        "statement-name": {
          "type": "string",
          "description": "Name of the Statement that this Charge belongs to",
          "format": "string",
          "readOnly": true
        },
        "supplier": {
        ...
        "supplier-id": {
          "type": "integer",
          "description": "Unique Coupa Supplier ID",
          "format": "integer",
          "readOnly": true
        },
        "supplier-name": {
          "type": "string",
          "description": "Supplier in Coupa that made the charge",
          "format": "string",
          "readOnly": true
        },
        "total": {
          "type": "number",
          "description": "Total of the charge in the card base currency",
          "format": "decimal"
        },
        "updated-at": {
          "type": "string",
        ...
        "virtual-card-id": {
          "type": "integer",
          "description": "Coupa ID for associated Virtual Card",
          "format": "integer",
          "readOnly": true
        }
      },
    ...
    "CoupaPay-PaymentPartner": {
      ...
      "properties": {
        ...
        "products": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/CoupaPay-PaymentPartner-Product"
          }
        },
        "support-contact": {
          "$ref": "#/definitions/UserSimple"
    ...
    "CoupaPay-PaymentPartner-Product": {
      "type": "object",
      "properties": {
        "id": {
          "type": "integer",
    ...
    "CoupaPay-Statement": {
      ...
      "properties": {
        ...
        "number-of-lines": {
          "type": "integer",
          "description": "Number of lines on the statement",
          "format": "integer",
          "readOnly": true
        },
        "payment-partner": {
