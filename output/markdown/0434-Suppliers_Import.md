...
url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/coupa-core-flat-files-(csv)/flat-file-(csv)-import/suppliers-import"
final_url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/coupa-core-flat-files-(csv)/flat-file-(csv)-import/suppliers-import"
status_code: 200
...
| Primary Address Tax Type | No | No | | Your supplier's country specific tax type | |
...
| Remit-To Requirements | No | No | | Must be either "Address Only" or "Must include payment information" | |
...
| Exempt from Risk Aware | No | No | boolean | Exempt from Risk Aware | |
| Service Sheet Required | No | No | boolean | Service Sheet Required | yes, no, yes_customer |
| Strategic Supplier | No | No | boolean | Strategic Supplier | |
