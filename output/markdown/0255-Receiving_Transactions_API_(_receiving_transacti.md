---
title: "Receiving Transactions API (/receiving_transactions)"
...
final_url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-coupa-core-api/resources/transactional-resources/receipts-api/receiving-transactions-api-(receiving_transactions)"
status_code: 200
...
The URL to access receiving transactions is:
`https:///api/receiving_transactions`
...
Receiving Transactions allows you to:

| **Verb** | **Path** | **Action** | **Description** |
| --- | --- | --- | --- |
| POST | `/api/receiving_transactions` | create | Create receiving transaction |
| DELETE | `/api/receiving_transactions/:id` | destroy | Delete receiving transaction |
| GET | `/api/receiving_transactions` | index | Query receiving transactions |
| GET | `/api/receiving_transactions/:id` | show | Show receiving transaction |
| GET | `/api/receipt_requests` | index | Query Receipt Requests |
| | ![](https://compass.coupa.com/DITARoot/icons/important.png) Note:<br>Currently, approver details are not available via API on receipts. To query receipt requests with approvers, use the following path:<br>@@BLOCK_0@@ | | |
| PATCH | `/api/receiving_transactions/:id` | update | Update receiving transaction export flag only |
| PUT | `/api/receiving_transactions/:id` | update | Update receiving transaction export flag only |
| PUT | `/api/receiving_transactions/:id/void` | void | Perform Void action on receiving transaction |

The **Type** payload for
`/api/receiving_transactions` includes:
...
For more information about the Receiving Transactions API payload, see [Receipts API Example Calls](https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-coupa-core-api/resources/transactional-resources/receipts-api/receipts-api-example-calls) .
