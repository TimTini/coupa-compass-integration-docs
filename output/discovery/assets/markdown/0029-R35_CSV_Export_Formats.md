---
title: "R35_CSV_Export_Formats.xlsx"
url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/CSV/R35_CSV_Export_Formats.xlsx"
final_url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/CSV/R35_CSV_Export_Formats.xlsx"
content_type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
classification: "xlsx_asset"
fetched_at: "2026-04-10T01:55:39+00:00"
---

# R35_CSV_Export_Formats.xlsx

- Raw file: `assets\raw\0029-R35_CSV_Export_Formats.xlsx`
- Extracted text: `assets\text\0029-R35_CSV_Export_Formats.txt`
...
1.0	custom-field-1	Integration Custom Field 1	0	0		any
2.0	custom-field-2	Integration Custom Field 2	0	0		any
3.0	custom-field-3	Integration Custom Field 3	0	0		any
4.0	custom-field-4	Integration Custom Field 4	0	0		any
5.0	custom-field-5	Integration Custom Field 5	0	0		any
6.0	custom-field-6	Integration Custom Field 6	0	0		any
7.0	custom-field-7	Integration Custom Field 7	0	0		any
8.0	custom-field-8	Integration Custom Field 8	0	0		any
9.0	custom-field-9	Integration Custom Field 9	0	0		any
10.0	custom-field-10	Integration Custom Field 10	0	0		any
...
2.0	Payment Date	The date the payment was made	No/No		datetime
3.0	Payment Type	The type of payment that was made	No/No	string(255)
4.0	Amount Paid	The total amount paid	No/No	decimal(32,4)
5.0	Payable ID	The document ID that is being paid	No/No	integer(11)
6.0	Created By ID	The user ID that created the payment	No/No	integer(11)
7.0	Created By Login	The user login that created the invoice payment	No/No	string(255)
8.0	Created Date	The date the payment initially drafted	No/No	datetime
9.0	Updated By ID	The user ID that most recently updated the payment	No/No	integer(11)
10.0	Updated By Login	Ther user login that most recently updated the invoice payment	No/No	string(255)
11.0	Updated Date	The date the payment was most recently updated	No/No	datetime
12.0	Notes	Notes associated with the payment	No/No	string(255)
13.0	Payment Type	The payment type	No/No		any
14.0	Description	Description provided describing the payment	No/No	string(255)	any
15.0	Payment Identifier	Payment Identifier provided used to reference the payment	No/No	string(255)	any
...
Source	The source of this allocation. Possible values are coupa_pay.	No/No	string(255)	coupa_pay, erp, ui, csv
...
# Sheet: Integration History Record
Position	Column Name	Description	Req'd	Unique	Type	Allowable Values
1.0	custom-field-1	Integration Custom Field 1	0	0		any
2.0	custom-field-2	Integration Custom Field 2	0	0		any
3.0	custom-field-3	Integration Custom Field 3	0	0		any
...
45.0	category	Used to automate tax codes in Coupa Invoicing. Acceptable values: Goods, Services, Monetary, or Others.	string(255)	No/No	goods, services
...
# Sheet: Item
Position	Column Name	Description	Type	Req/Unique	Allowable Values
1.0	Name	Item's Name	string(255)	Yes/No	any
2.0	Description	Item's Description	text	Yes/No	any
3.0	UOM Code	Item's Unit Of Measure Code	UoM	No/No	any
4.0	Purchasable	Flag if item is purchasable	boolean	No/No	any
5.0	Item Number	Item Number	string(255)	No/Yes	any
6.0	Image Url	Item's Image Url		No/No	any
7.0	Commodity	Item's Commodity Name	Commodity	No/No	any
8.0	Tags	Item's Tags	Tags	No/No	any
9.0	Require Inspection?	Does the item require an Inspection?	boolean	No/No	any
10.0	Require Asset Tag?	Does the item require an Asset Tag?	boolean	No/No	any
11.0	Require RFID?	Does the item require an RFID tag?	boolean	No/No	any
12.0	Created At	Date document was created	datetime	No/No	any
13.0	Updated At	Date document was last updated	datetime	No/No	any
...
# Sheet: Order Header Confirmation
Position	Column Name	Description	Req'd	Unique	Type	Allowable Values
1.0	type	Indicates record type	0	0		any
2.0	id	Coupa's internal ID	0	0	integer	any
3.0	status	PO Confirmation Status	0	0	string(255)	any
4.0	order-header-id	Coupa's internal ID	0	0	integer	any
5.0	order-header-version-id	Coupa's internal ID	0	0	integer	any
6.0	external-reference-number	External Reference Number	0	0	string(255)	any
7.0	integration-message	Integration Message	0	0	text	any
8.0	created-at	Created Date	0	0	datetime	any
9.0	updated-at	Last Updated at Date	0	0	datetime	any
...
# Sheet: Order Line Change Allocation
Position	Column Name	Description	Req'd	Unique	Type	Allowable Values
1.0	custom-field-1	Integration Custom Field 1	0	0		any
2.0	custom-field-2	Integration Custom Field 2	0	0		any
3.0	custom-field-3	Integration Custom Field 3	0	0		any
...
# Sheet: Order Line Confirmation
Position	Column Name	Description	Req'd	Unique	Type	Allowable Values
1.0	type	Indicates record type	0	0		any
2.0	id	Coupa's internal ID	0	0	integer	any
3.0	status	PO Line Confirmation Status	0	0	string(255)	any
4.0	confirm-by-hrs	Confirm By Hours	0	0	decimal(10,0)	any
5.0	quantity	Quantity	0	0	decimal(30,6)	any
6.0	price	Price	0	0	decimal(30,6)	any
7.0	currency-id	Currency	0	0	integer	any
8.0	order-line-id	Coupa's internal ID	0	0	integer	any
9.0	order-line-version-id	Coupa's internal ID	0	0	integer	any
10.0	need-by-date	Need by date	0	0	datetime	any
11.0	order_header_confirmation_id	Coupa's internal ID	0	0	integer	any
12.0	can-fulfill	Is supplier can fulfill the order?	0	0	integer	any
13.0	proposed_by	Proposed by	0	0	string(255)	any
14.0	created-at	Created Date	0	0	datetime	any
15.0	updated-at	Last Updated at Date	0	0	datetime	any
...
6.0	payable-from-currency	Currency of the sending payable		Yes/No	any
...
13.0	payable-to-currency	Currency of the receiving payable		Yes/No	any
...
18.0	source	One of erp, coupa_pay, ui, api, csv	string(255)	No/No	coupa_pay, erp, ui, api, csv
...
33.0	custom-field-9		Integration Custom Field 9	No/No	any
34.0	custom-field-10		Integration Custom Field 10	No/No	any
35.0	discount-due-date	datetime	The discount due date.	No/No	any
36.0	wc-eligibility	string(255)	Eligible for Coupa Pay Working Capital	No/No	any
...
94.0	Hidden 	Hidden	0	0
95.0	Template ID	Template ID	0	0	integer	any
...
Remit To Contact Email	The email address of the individual responsible for Remit To information	0	0	string(255)	any
Credit Card Email	Email address to whom the Virtual Credit card will be delivered	0	0	string(255)	any
...
Contact Type	The job role of the supplier contact.	1	0	string(255)	Standard
...
Supplier Information Id	Supplier Information Id	0	0	integer	any
custom-field-1	Integration Custom Field 1	0	0		any
custom-field-2	Integration Custom Field 2	0	0		any
custom-field-3	Integration Custom Field 3	0	0		any
custom-field-4	Integration Custom Field 4	0	0		any
...
# Sheet: Supplier Diversity Report Direc
Supplier Diversity Report Direct Spends Columns
Column Name	Description	Req'd	Unique	Type	Allowable Values
reporting-period	Reporting Period	0	0	string(255)	any
start-date	Start Date	0	0	datetime	any
end-date	End Date	0	0	datetime	any
status	Status	0	0
tier-2-supplier	Tier 2 Supplier	0	0	string(255)	any
prime-supplier	Prime Supplier	0	0	string(255)	any
diversity-category	Diversity Category	0	0
certificate-type	Certificate Type	0	0	string(255)	any
certificate-number	Certificate Number	0	0	string(255)	any
expiration-date	Expiration Date	0	0	datetime	any
total-spend	Total Spend	0	0	decimal	numeric
currency	Currency	0	0		any
...
# Sheet: Supplier Diversity Report Indir
Supplier Diversity Report Indirect Spends Columns
Column Name	Description	Req'd	Unique	Type	Allowable Values
reporting-period	Reporting Period	0	0	string(255)	any
start-date	Start Date	0	0	datetime	any
end-date	End Date	0	0	datetime	any
status	Status	0	0	boolean
prime-supplier	Prime Supplier	0	0	string(255)	any
diversity-category	Diversity Category	0	0
indirect-spend	Indirect Spend	0	0	decimal	numeric
indirect-spend-credit	Indirect Spend Credit	0	0	decimal	numeric
currency	Currency	0	0		any
...
# Sheet: Supplier Diversity Report Summa
Supplier Diversity Report Direct Spends Columns
Column Name	Description	Req'd	Unique	Type	Allowable Values
reporting-period	Reporting Period	0	0	string(255)	any
start-date	Start Date	0	0	datetime	any
...
status	Status	0	0
diversity-category	Diversity Category	0	0
direct-spend-credit	Direct Spend Credit	0	0	decimal	numeric
indirect-spend	Indirect Spend	0	0	decimal	numeric
indirect-spend-credit	Indirect Spend Credit	0	0	decimal	numeric
total-spend	Total Spend	0	0	decimal	numeric
currency	Currency	0	0		any
...
cXML SSL Version	cXML SSL Version	0	0	string(255)	any
Disable Cert Verify	Disable Cert Verify	0	0	boolean	any
Supplier Id	Supplier Id	0	0	integer	any
custom-field-1	Integration Custom Field 1	0	0	string(255)	any
custom-field-2	Integration Custom Field 2	0	0	string(255)	any
custom-field-3	Integration Custom Field 3	0	0	string(255)	any
custom-field-4	Integration Custom Field 4	0	0	string(255)	any
...
# Sheet: Work ConfirmationHeader (Servic
Position	Column Name	Description	Req'd	Unique	Type	Allowable Values
1.0	custom-field-1	Integration Custom Field 1	0	0		any
2.0	custom-field-2	Integration Custom Field 2	0	0		any
3.0	custom-field-3	Integration Custom Field 3	0	0		any
...
# Sheet: Work ConfirmationLine (ServiceT
Position	Column Name	Description	Req'd	Unique	Type	Allowable Values
1.0	custom-field-1	Integration Custom Field 1	0	0		any
2.0	custom-field-2	Integration Custom Field 2	0	0		any
3.0	custom-field-3	Integration Custom Field 3	0	0		any
