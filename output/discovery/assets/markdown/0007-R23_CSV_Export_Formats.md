---
title: "R23_CSV_Export_Formats.xlsx"
url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/CSV/R23_CSV_Export_Formats.xlsx"
final_url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/CSV/R23_CSV_Export_Formats.xlsx"
content_type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
classification: "xlsx_asset"
fetched_at: "2026-04-10T01:55:00+00:00"
---

# R23_CSV_Export_Formats.xlsx

- Raw file: `assets\raw\0007-R23_CSV_Export_Formats.xlsx`
- Extracted text: `assets\text\0007-R23_CSV_Export_Formats.txt`
...
12.0	VAT Number	VAT Number	0	0	string(47)	any
...
25.0	Updated By Login	Ther user login that most recently updated the approval	string(255)	No/No
...
# Sheet: Approval Delegate
Position	Column Name	Description	Type	Req/Unique	Allowable Values
1.0	Approver ID	The user ID that made the approval	integer(11)	No/No
2.0	Approver Login	The user login that made the approver	string(255)	No/No
3.0	Delegate ID	The delegate ID that made the approval (if applicable)	integer(11)	No/No
4.0	Delegate Login	The delegate login that made the approver	string(255)	No/No
5.0	Delegation Start Date	The day the delegation period begins	datetime	Yes/No
6.0	Delegation End Date	The day the delegation period ends	datetime	Yes/No
7.0	Delegation Reason	The reason for the approval	string(255)	Yes/No
8.0	Created By ID	The user ID that created the approval delegation	integer(11)	No/No
9.0	Created By Login	The user login that created the approval delegate	string(255)	No/No
10.0	Created Date	The date the user create the approval delegation	datetime	No/No
11.0	Updated By ID	The user ID that most recently updated the approval delegation	integer(11)	No/No
12.0	Updated By Login	Ther user login that most recently updated the approval delegate	string(255)	No/No
13.0	Updated Date	The date the approval delegation was most recently updated	datetime	No/No
...
23.0	Submitted By Login	Ther user login that submitted the approval	string(255)	No/No
24.0	Is Default	Is this the detault (Y/N)	boolean	No/No
...
101.0	early-payment-provisions	Early Payment Provisions	string(255)	No/No	Any
102.0	pre-payment-date	Pre-Payment Date	datetime	No/No	YYYY-MM-DDTHH:MM:SS+HH:MM
103.0	reverse-charge-reference	Reverse Charge Reference	string(255)	No/No	Any
104.0	discount-percent	Discount %	float	No/No	Any
105.0	credit-note-differences-with-original-invoice	Credit Note differences with Original Invoice	decimal(30,4)	No/No	Any
106.0	customs-declaration-number	Customs Declaration Number	string(255)	No/No	Any
107.0	customs-office	Customs Office	text	No/No	Any
108.0	customs-declaration-date	Customs Declaration Date	datetime	No/No	YYYY-MM-DDTHH:MM:SS+HH:MM
109.0	payment-order-reference	A code given by banks to use it instead of a bank account transfer.	string(255)	No/No
110.0	advance-payment-received-amount	Amount of advance payment received	decimal(30,4)	No/No	Any
111.0	series	The serial number used by the Company for internal control of the information.	string(255)	No/No	Any
112.0	folio-number	The internal folio number used by the Company.	string(255)	No/No	Any
113.0	use-of-invoice	The purpose invoice is going to be used for.	string(255)	No/No	Any
114.0	form-of-payment	The specific code in accordance with a catalogue: cash, check, transfer of funds, etc.	string(255)	No/No	Any
115.0	type-of-receipt	Type of the invoice: income, expense, transfer, payroll or payment.	string(255)	No/No	Any
116.0	payment-method	Installments or lump sum payments.	string(255)	No/No	Any
117.0	issuance-place	Issuance Place	string(255)	No/No	Any
118.0	confirmation	This is a unique number provided by the Tax Authorities or the PAC.	string(255)	No/No	Any
119.0	withholding-tax-override	Withholding Tax Override	decimal(30,3)	No/No	Any
120.0	type-of-relationship	Relationship of this document to its parent invoice. Chosen from a catalog.	string(255)	No/No	Any
121.0	gross-total	Gross Total	decimal	No/No	Any
122.0	registered-company-registration-number	Registration number of the registered company	string(255)	No/No	Any
123.0	registered-company-place-of-registration	Place of registration of the registered company	string(255)	No/No	Any
124.0	registered-company-type	The type of the registered company	string(255)	No/No	Any
125.0	registered-company-managing-directors	A list of managing directors of the registered company	string(255)	No/No	Any
126.0	credit-reason	The reason of creating the credit	string(255)	No/No	Any
127.0	registered-company-permit-number	Permit number of the registered company	string(255)	No/No	Any
128.0	registered-company-permit-date	Permit date of the registered company	string(255)	No/No	Any
129.0	registered-company-liquidator-name	Liquidator name of the registered company	string(255)	No/No	Any
130.0	registered-company-share-capital	Share capital of the registered company	string(255)	No/No	Any
131.0	Tax Nature	Estonia compliance required field	string(255)	No/No	Any
132.0	registered-company-unique-shareholder	Unique shareholder of the registered company	string(255)	No/No	Any
133.0	registered-company-liable-company	Liable company of the registered company	string(255)	No/No	Any
134.0	registered-company-tax-regime	Tax Regime of the registered company	string(255)	No/No	Any
135.0	registered-company-legal-status	Legal status of the company (for tax and compliance purposes).	string(255)	No/No	Any
136.0	QST Registration Number	QST Registration Number	string(255)	No/No	Any
137.0	Authorised Person	Authorised Person	string(255)	No/No	Any
138.0	Authorised Person Address	Authorised Person Address	string(255)	No/No	Any
139.0	Authorised Person VAT ID	Authorised Person VAT ID	string(255)	No/No	Any
140.0	Date of Registration	Date of Registration	string(255)	No/No	Any
141.0	Sole Registration Code	Sole Registration Code	datetime	No/No	YYYY-MM-DDTHH:MM:SS+HH:MM
142.0	origin-currency-net	Net Amount in local currency	decimal(32,4)	Yes/No	Any
143.0	taxes-in-origin-country-currency	Tax Amount in local currency	decimal(32,4)	Yes/No	Any
144.0	origin-currency-gross	Gross Amount in local currency	decimal(32,4)	Yes/No	Any
145.0	self-billing-reference	Self billing reference - used for compliant countries like The Netherlands	string(255)	No/No	Any
146.0	registered-company-legal-type	Legal type of the company (for tax and compliance purposes).	string(255)	No/No	Any
147.0	registered-company-registered-seat	Registered seat of the company (for tax and compliance purposes).	string(255)	No/No	Any
148.0	registered-company-chairman-of-the-board	Name of the chairperson of the board (for tax and compliance purposes).	string(255)	No/No	Any
149.0	registered-company-court-of-registration	Court where the company is registered (for tax and compliance purposes).	string(255)	No/No	Any
150.0	registered-company-liquidation-remark	Remark if the company is in liquidation (for tax and compliance purposes).	string(255)	No/No	Any
151.0	registered-company-commercial-register-number	Commercial register number of the company (for tax and compliance purposes).	string(255)	No/No	Any
152.0	Disputed Invoice Number	Disputed Invoice Number	string(40)	No/No	Any
153.0	Channel	Channel the invoice was created from	string(255)	No/No	Any
154.0	Taxable Amount	Taxable Amount	decimal(32,4)	No/No	Any
155.0	invoice-from-code	The name/code given to the supplier invoice-from address by the supplier.	string(255)	No/No	Any
156.0	invoice-from-supplier-name	The user-friendly name given to the invoice-from address by the supplier to make it more easily identifiable	string(100)	No/No	Any
157.0	invoice-from-street1	The supplier-created invoice-from first address line.	string(100)	No/No	Any
158.0	invoice-from-street2	The supplier-created invoice-from second address line.	string(100)	No/No	Any
159.0	invoice-from-city	The supplier-created invoice-from city.	string(50)	No/No	Any
160.0	invoice-from-state	The supplier-created invoice-from state.	string(50)	No/No	Any
161.0	invoice-from-postal-code	The supplier-created invoice-from zip or postal code.	string(50)	No/No	Any
162.0	invoice-from-country-code	The supplier-created invoice-from country code.	string(4)	No/No	Any
163.0	invoice-from-country-name	The supplier-created invoice-from country name.	string(100)	No/No	Any
164.0	ship-from-code	The name/code given to the supplier ship-from address by the supplier	string(255)	No/No	Any
165.0	ship-from-supplier-name	The user-friendly name given to the ship-from address by the supplier to make it more easily identifiable	string(100)	No/No	Any
166.0	ship-from-street1	The supplier-created ship-from first address line.	string(100)	No/No	Any
167.0	ship-from-street2	The supplier-created ship-from second address line.	string(100)	No/No	Any
168.0	ship-from-city	The supplier-created ship-from city.	string(50)	No/No	Any
169.0	ship-from-state	The supplier-created ship-from state.	string(50)	No/No	Any
170.0	ship-from-postal-code	The supplier-created ship-from zip or postal code.	string(50)	No/No	Any
171.0	ship-from-country-code	The supplier-created ship-from country code.	string(4)	No/No	Any
172.0	ship-from-country-name	The supplier-created ship-from country name.	string(100)	No/No	Any
173.0	supplier-tax-registration-number	The supplier-created supplier-tax-number.	string(255)	No/No	Any
174.0	supplier-tax-registration-country-code	The supplier-created supplier-tax-registration country code.	string(100)	No/No	Any
175.0	supplier-tax-registration-country-name	The supplier-created supplier-tax-registration country name.	string(4)	No/No	Any
176.0	supplier-tax-registration-local	The supplier-created supplier-tax-registration local indicator.	boolean	No/No	Yes/No, True/False
177.0	buyer-tax-registration-number	The buyer-created buyer-tax-number.	string(255)	No/No	Any
178.0	buyer-tax-registration-country-code	The buyer-created buyer-tax-registration country code.	string(100)	No/No	Any
179.0	buyer-tax-registration-country-name	The buyer-created buyer-tax-registration country name.	string(4)	No/No	Any
180.0	buyer-tax-registration-local	The buyer-created buyer-tax-registration local indicator.	boolean	No/No	Yes/No, True/False
181.0	delivery-date	The date of supply in the format YYYY-MM-DDTHH:MM:SS+HH:MMZ.	datetime	No/No	YYYY-MM-DDTHH:MM:SS+HH:MMZ
182.0	registered-company-license-number	Company License Number		No/No	any
183.0	registered-company-register-legal-entities	Register Legal Entities		No/No	any
184.0	registered-company-name	Registered Company Name		No/No	any
185.0	dispute-method	Dispute Method, Possible values are: Auto, Manual	string(10)	No/No	Auto, Manual
186.0	date-received	The date when the invoice is received by enterprise via email	date	No/No	any
187.0	sender-email	The sender email who sent the invoice to enterprise via email		No/No	any
188.0	inbox-name	Inbox which the invoice was received into		No/No	any
189.0	amount-due	Amount due to the supplier - Invoice Total without withholding and customer accounting taxes		No/No	any
190.0	tax-due-to-supplier	Tax due to the supplier	decimal(46,6)	No/No	any
191.0	customer-accounting-tax	Customer accounting tax	decimal(46,6)	No/No	any
...
10.0	description	The invoice line description, usually taken from the description of the item.	string(255)	Yes/No	Any
...
18.0	price	The price of the order line item.	decimal(46,20)	Yes/No	Any
19.0	quantity	The quantity of the order line item.	decimal(30,6)	No/No	Any
...
42.0	customs-declaration-number	Customs Declaration Number	string(255)	No/No	Any
...
4.0	type	The kind of charge. Possible values are InvoiceShippingCharge, InvoiceHandlingCharge, or InvoiceMiscCharge.	string(255)	No/No	Any
...
type	Line Type	0	0	string(100)	any
...
Price	Unit Price of Item	0	0	decimal(30,6)	any
