---
title: "R32_CSV_Export_Formats.xlsx"
url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/CSV/R32_CSV_Export_Formats.xlsx"
final_url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/CSV/R32_CSV_Export_Formats.xlsx"
content_type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
classification: "xlsx_asset"
fetched_at: "2026-04-10T01:55:27+00:00"
---

# R32_CSV_Export_Formats.xlsx

- Raw file: `assets\raw\0023-R32_CSV_Export_Formats.xlsx`
- Extracted text: `assets\text\0023-R32_CSV_Export_Formats.txt`
...
3.0	Line 1	Street Line 1 of the address	1	0	string(255)	any
...
41.0	posting-date	datetime	Date the charge posted to the card's bank	No/No	any
...
25.0	charge-id	integer	The unique identifier Coupa assigns to the charge.	No/No	any
...
Source	The source of this allocation. Possible values are coupa_pay.	No/No	string(255)	coupa_pay, erp, ui
Reason Code	The reason code for the most recent change to this allocation.	No/No	string(40)	payment, auto_payment, epr, epr_rejected, manual
custom-field-1	Integration Custom Field 1	No/No		any
custom-field-2	Integration Custom Field 2	No/No		any
custom-field-3	Integration Custom Field 3	No/No		any
custom-field-4	Integration Custom Field 4	No/No		any
...
# Sheet: Payables  Allocation
Position	Column Name	Description	Type	Req/Unique	Allowable Values
1.0	type	Describes the type of row		No/No	any
2.0	id	ID	integer	No/No	any
3.0	payable-from-id	ID of payable sending the allocation	integer	No/No	any
4.0	payable-from-type	Type of payable sending the allocation	string(255)	No/No	any
5.0	payable-from-amount	Amount of sent allocation in the sender's currency	decimal(46,20)	Yes/No	any
6.0	payable-from-currency	Currency of the sending payable		No/No	any
7.0	source-transaction-from-id	Source transaction ID of the sending payable		No/No	any
8.0	source-transaction-from-type	Source Transaction type of the sending payable		No/No	any
9.0	source-transaction-from-reference	Source Transaction Reference		No/No	any
10.0	payable-to-id	ID of payable receiving the allocation	integer	No/No	any
11.0	payable-to-type	Type of payable receiving the allocation	string(255)	No/No	any
12.0	payable-to-amount	Amount of received allocation in the receiver's currency	decimal(46,20)	Yes/No	any
13.0	payable-to-currency	Currency of the receiving payable		No/No	any
14.0	source-transaction-to-id	Source transaction ID of the receiving payable		No/No	any
15.0	source-transaction-to-type	Source transaction type of the receiving payable		No/No	any
16.0	source-transaction-to-reference	Source transaction reference of the receiving payable		No/No	any
17.0	status	Status	string(255)	No/No	any
18.0	source	One of erp, coupa_pay, ui	string(255)	No/No	coupa_pay, erp, ui
19.0	reason-code	One of payment, auto_payment, epr, epr_rejected, manual	string(40)	No/No	payment, auto_payment, epr, epr_rejected, manual
20.0	payment-reference-id	Reference ID of the payament	integer	No/No	any
21.0	payment-reference-type	Type of the payment reference	string(255)	No/No	any
22.0	last-exported-at	Last date the allocation was exported	datetime	No/No	any
23.0	custom-field-1	Integration Custom Field 1		No/No	any
24.0	custom-field-2	Integration Custom Field 2		No/No	any
25.0	custom-field-3	Integration Custom Field 3		No/No	any
26.0	custom-field-4	Integration Custom Field 4		No/No	any
27.0	custom-field-5	Integration Custom Field 5		No/No	any
28.0	custom-field-6	Integration Custom Field 6		No/No	any
29.0	custom-field-7	Integration Custom Field 7		No/No	any
30.0	custom-field-8	Integration Custom Field 8		No/No	any
31.0	custom-field-9	Integration Custom Field 9		No/No	any
32.0	custom-field-10	Integration Custom Field 10		No/No	any

# Sheet: Payables  Expense
Position	Column Name	Description	Type	Req/Unique	Allowable Values
1.0	type	Describes the type of row. Possible value is Expense		No/No	any
2.0	id	The ID of the expense	integer	No/No	any
3.0	created-at	The date the expense was created on	datetime	No/No	any
4.0	updated-at	The date the expense was last updated on	datetime	No/No	any
5.0	status	The status of the expense	string(255)	No/No	any
6.0	paid-date	The date the expense was marked as fully paid	datetime	No/No	any
...
10.0	accounting-total	The total of the expense in the CoA currency	decimal	No/No	any
11.0	exported	A flag indicating if the expense has been marked as exported		No/No	any
12.0	last-exported-at	The date that the expense was last marked as exported	datetime	No/No	any
13.0	document-type	The type of expense		No/No	any
14.0	payment-channel	The payment channel on the associated ExpenseReport	string(255)	No/No	any
15.0	payable-type	The type of associated payable. Value is ExpenseReport		No/No	any
16.0	payable-id	The ID of the associated ExpenseReport		No/No	any
17.0	chart-of-account-code	The Chart of Accounts name		No/No	any
18.0	legal-entity-name	The Chart of Accounts Legal Entity name		No/No	any
19.0	custom-field-1	Integration Custom Field 1	string(255)	No/No	any
20.0	custom-field-2	Integration Custom Field 2	string(255)	No/No	any
21.0	custom-field-3	Integration Custom Field 3	string(255)	No/No	any
22.0	custom-field-4	Integration Custom Field 4	string(255)	No/No	any
23.0	custom-field-5	Integration Custom Field 5	string(255)	No/No	any
24.0	custom-field-6	Integration Custom Field 6	string(255)	No/No	any
25.0	custom-field-7	Integration Custom Field 7	string(255)	No/No	any
26.0	custom-field-8	Integration Custom Field 8	string(255)	No/No	any
27.0	custom-field-9	Integration Custom Field 9	string(255)	No/No	any
28.0	custom-field-10	Integration Custom Field 10	string(255)	No/No	any
...
Position	Column Name	Type	Description	Req/Unique	Allowable Values
1.0	type		Describes the type of row. Possible value is InvoicePayable	No/No	any
...
5.0	Line 1	Street Line 1 of the address	string(255)	Yes/No	any
6.0	Line 2	Street Line 2 of the address	string(255)	No/No	any
7.0	City	City of the address	string(255)	Yes/No	any
8.0	State	State of the address	string(255)	No/No	any
9.0	Postal Code	Zip code or postal code	string(255)	Yes/No	any
...
Address Type	The type of address of this record.	0	0	string(255)	1, 2, 3, "Standard", "User"
...
Bank Wire Routing Number	The bank wire routing number.	0	0		any
Tax Numbers	Tax Numbers	0	0		any
Tax Countries	Tax Countries	0	0		any
Purpose	The names of the address purposes.	0	0		any
...
# Sheet: Supplier Information Site
Supplier Information Site Columns
Column Name	Description	Req'd	Unique	Type	Allowable Values
RecordType	Specifies the header format for the row.	0	0		any
Code	Supplier Information site code	1	1	string(20)	any
Name	Supplier Information Site name	1	0	string(255)	any
Id	Coupa Unique Supplier Id	0	0	integer	any
PO Method	PO Method	0	0	string(255)	any
PO Change Method	PO Change Method	0	0	string(255)	any
Buyer Hold	Buyer Hold	0	0	boolean	any
PO Email	PO Email	0	0	string(255)	any
Payment Terms	Payment Terms	0	0		any
Shipping Terms	Shipping Terms	0	0		any
PO cXML URL	PO cXML URL	0	0	string(255)	any
PO cXML Domain	PO cXML Domain	0	0	string(255)	any
PO cXML Identity	PO cXML Identity	0	0	string(255)	any
PO cXML Supplier Domain	PO cXML Supplier Domain	0	0	string(255)	any
PO cXML Supplier Identity	PO cXML Supplier Identity	0	0	string(255)	any
PO cXML Secret	PO cXML Secret	0	0	string(255)	any
PO cXML Protocol	PO cXML Protocol	0	0	string(255)	any
cXML SSL Version	cXML SSL Version	0	0	string(255)	any
Disable Cert Verify	Disable Cert Verify	0	0	boolean	any
Address Id	Address Id	0	0		any
Address Street 1	Address Street 1	0	0		any
Address Street 2	Address Street 2	0	0		any
Address City	Address City	0	0		any
Address State	Address State	0	0		any
Address Postal code	Address Postal code	0	0		any
Address Country code	Address Country code	0	0		any
custom-field-1	Integration Custom Field 1	0	0		any
custom-field-2	Integration Custom Field 2	0	0		any
custom-field-3	Integration Custom Field 3	0	0		any
custom-field-4	Integration Custom Field 4	0	0		any
...
# Sheet: Supplier Site
Supplier Site Columns
Column Name	Description	Req'd	Unique	Type	Allowable Values
Code	Supplier site code	1	1	string(20)	any
Name	Supplier Site name	1	0	string(255)	any
Id	Coupa Unique Supplier Id	0	0	integer	any
PO Method	PO Method	0	0	string(255)	cxml, xml, email, prompt, mark_as_sent, buy_online
PO Change Method	PO Change Method	0	0	string(255)	cxml, xml, email, prompt, mark_as_sent, buy_online
Buyer Hold	Buyer Hold	0	0	boolean	any
PO Email	PO Email	1	0	string(255)	any
Payment Terms	Payment Terms	0	0		any
Shipping Terms	Shipping Terms	0	0		any
PO cXML URL	PO cXML URL	1	0	string(255)	any
PO cXML Domain	PO cXML Domain	1	0	string(255)	any
PO cXML Identity	PO cXML Identity	1	0	string(255)	any
PO cXML Supplier Domain	PO cXML Supplier Domain	1	0	string(255)	any
PO cXML Supplier Identity	PO cXML Supplier Identity	1	0	string(255)	any
PO cXML Secret	PO cXML Secret	1	0	string(255)	any
PO cXML Protocol	PO cXML Protocol	1	0	string(255)	any
cXML SSL Version	cXML SSL Version	0	0	string(255)	any
Disable Cert Verify	Disable Cert Verify	0	0	boolean	any
custom-field-1	Integration Custom Field 1	0	0	string(255)	any
custom-field-2	Integration Custom Field 2	0	0	string(255)	any
