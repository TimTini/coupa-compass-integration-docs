---
title: "R39_Sourcing_API.json"
url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/R39/R39_Sourcing_API.json"
final_url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/R39/R39_Sourcing_API.json"
content_type: "application/json"
classification: "json_asset"
fetched_at: "2026-04-10T01:56:24+00:00"
---

# R39_Sourcing_API.json
...
```json
{
  ...
  "info": {
    "version": "",
    "title": "Coupa API",
    "description": "RESTful API that provides robust access to read, edit, or integrate your data with the Coupa platform. The [JSON](/api_docs/3.json) and [YAML](/api_docs/3.yaml) are also available.  To test with OAuth2 OAuth2AccessCode, make sure to include https://r39.coupadev.com/oauth2-redirect.html in the client's Redirect URI list"
  },
  ...
  "paths": {
    ...
    "/quote_requests/{quote_request_id}/quote_responses/all": {
      "get": {
        "tags": [
          "QuoteResponse"
        ],
        "summary": "Get all responses for Sourcing events (including all submitted and draft responses)",
        "description": "Get all responses for Sourcing events (including all submitted and draft responses)",
        "produces": [
          "application/xml",
          "application/json"
        ],
    ...
    "/quote_requests/{quote_request_id}/pending_quote_suppliers": {
      "get": {
        "tags": [
          "QuoteSupplier"
        ],
        "summary": "List all the pending quote suppliers",
        "description": "List all the pending quote suppliers",
        "produces": [
          "application/xml",
          "application/json"
        ],
        ...
        "responses": {
          "200": {
            "description": "QuoteSupplier objects",
            "schema": {
              "type": "array",
              "items": {
      ...
      "post": {
        ...
        "summary": "Create a pending quote supplier",
        "description": "Create a pending quote supplier",
        "consumes": [
          "application/xml",
          "application/json"
        ],
  ...
  "securityDefinitions": {
    "OAuth2ClientCredential": {
      ...
      "scopes": {
        "core.sourcing.pending_supplier.read": "Allows to list all pending quote suppliers",
        "core.sourcing.pending_supplier.write": "Allows to create a new pending quote supplier",
        "core.sourcing.read": "Allows to view Sourcing Events",
        "core.sourcing.response.award.write": "Allows to award/unaward the response through API",
        "core.sourcing.response.read": "Allows to view responses for the Sourcing event",
        "core.sourcing.response.write": "Allows to update a quote response through API",
        "core.sourcing.write": "Allows to create or update Sourcing Events"
      }
    },
    "OAuth2AccessCode": {
      "type": "oauth2",
  ...
  "definitions": {
    ...
    "EasyForm": {
      ...
      "properties": {
        ...
        "hide-from-search": {
          "type": "boolean",
          "description": "Hide from search flag",
          "format": "boolean",
          "readOnly": true
        },
        "id": {
        ...
        "scheduler-configuration": {
          "$ref": "#/definitions/EasyFormSchedulerConfiguration"
        },
        "status": {
          "type": "string",
        ...
        "warnings": {
          "type": "string",
          "description": "List of easy form warnings",
          "format": "#<Warnings::WarningMessages:0x00007f1edd37b150>",
          "readOnly": true
        }
      },
      "required": [
    ...
    "EasyFormSchedulerConfiguration": {
      "type": "object",
      "properties": {
        "created-at": {
          "type": "string",
        ...
        "first-reminder-day": {
          "type": "integer",
          "description": "First reminder day",
          "format": "integer",
          "readOnly": true
        },
        "form-cancellation-day": {
          "type": "integer",
          "description": "Form cancellation day",
          "format": "integer",
          "readOnly": true
        },
        "fourth-reminder-day": {
          "type": "integer",
          "description": "Fourth reminder day",
          "format": "integer",
          "readOnly": true
        },
        "id": {
        ...
        "remind-cancellation-requester": {
          "type": "boolean",
          "description": "Remind cancellation requester",
          "format": "boolean",
          "readOnly": true
        },
        "remind-cancellation-responder": {
          "type": "boolean",
          "description": "Remind cancellation responder",
          "format": "boolean",
          "readOnly": true
        },
        "remind-requester": {
          "type": "boolean",
          "description": "Remind requester",
          "format": "boolean",
          "readOnly": true
        },
        "remind-responder": {
          "type": "boolean",
          "description": "Remind responder",
          "format": "boolean",
          "readOnly": true
        },
        "second-reminder-day": {
          "type": "integer",
          "description": "Second reminder day",
          "format": "integer",
          "readOnly": true
        },
        "third-reminder-day": {
          "type": "integer",
          "description": "Third reminder day",
          "format": "integer",
          "readOnly": true
        },
        "updated-at": {
    ...
    "EasyFormWidget": {
      ...
      "properties": {
        ...
        "condition": {
          "$ref": "#/definitions/EasyFormWidgetSimpleCondition"
        },
        "created-at": {
          "type": "string",
          "description": "Automatically created by Coupa in the format YYYY-MM-DDTHH:MM:SS+HH:MMZ",
        ...
        "field-name": {
          "type": "string",
          "description": "The value of the widget's Reporting Name field on form builder page",
          "format": "string(255)"
        },
        "field-type": {
          "type": "string",
        ...
        "page-break-widget-id": {
          "type": "integer",
          "description": "Page break widget",
          "format": "integer",
          "readOnly": true
        },
        "position": {
        ...
        "supplier-visible-attachment": {
          "type": "boolean",
          "description": "Supplier visible attachment",
          "format": "boolean"
        },
        "type": {
          "type": "string",
    ...
    "EasyFormWidgetSimpleCondition": {
      ...
      "properties": {
        ...
        "lhs-field-name": {
          "type": "string",
          "description": "Lhs field name",
          "readOnly": true
        },
        "lhs-widget-id": {
          "type": "integer",
          "description": "Lhs widget",
          "format": "integer",
          "readOnly": true
        },
        "rhs": {
    ...
    "QuoteRequest": {
      ...
      "properties": {
        ...
        "allow-supplier-to-send-attachments": {
          "type": "boolean",
          "description": "If set to true by the buyer, the supplier is allowed to send attachments in the Instant Message center",
          "format": "boolean"
        },
        "attachments": {
          "type": "array",
        ...
        "cost-avoidance-currency": {
          "$ref": "#/definitions/Currency"
        },
        "creatable-from-id": {
          "type": "integer",
          "description": "Creatable From Object ID",
          "format": "integer",
          "readOnly": true
        },
        "creatable-from-type": {
          "type": "string",
          "description": "Creatable From Object Type",
          "format": "string(255)",
          "readOnly": true
        },
        "created-at": {
        ...
        "end-time": {
          "type": "string",
          "description": "Time when event should end, format: %m/%d/%y %I:%M %p %z. Default time: Event creation date + 14 days at 5pm",
          "format": "datetime"
        },
        "event-type": {
          "type": "string",
        ...
        "exported": {
          "type": "boolean",
          "description": "Indicates if event has been exported",
          "format": "boolean"
        },
        "exported?": {
          "type": "boolean",
        ...
        "hidden": {
          "type": "boolean",
          "description": "Is true if the event is a hidden event",
          "format": "boolean"
        },
        "id": {
          "type": "integer",
        ...
        "negotiated-savings-currency": {
          "$ref": "#/definitions/Currency"
        },
        "original-id": {
          "type": "integer",
          "description": "Coupa unique identifier for original event",
          "format": "integer",
          "readOnly": true
        },
        "planned-savings": {
        ...
        "public": {
          "type": "boolean",
          "description": "Is true if the event is a public event",
          "format": "boolean"
        },
        "quote-messages": {
          "type": "array",
        ...
        "sealing-stage": {
          "type": "integer",
          "description": "Sealing Stage",
          "format": "integer",
          "readOnly": true,
          "enum": [
            "all_envelopes_sealed",
            "envelope1_unsealed",
            "envelope2_unsealed"
          ]
        },
        ...
        "start-time": {
          "type": "string",
          "description": "Time when event should start, format: %m/%d/%y %I:%M %p %z. Default time: Event creation date at 5pm",
          "format": "datetime"
        },
        "state": {
          "type": "string",
        ...
        "submit-time": {
          "type": "string",
          "description": "Time when event should be submitted, format: %m/%d/%y %I:%M %p %z. Default time: none",
          "format": "datetime"
        },
        "tags": {
          "type": "array",
    ...
    "QuoteResponse": {
      ...
      "properties": {
        ...
        "exported": {
          "type": "boolean",
          "description": "Indicates if response has been exported",
          "format": "boolean",
          "readOnly": true
        },
        "id": {
        ...
        "lines": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/QuoteResponseLine"
          }
        },
        "position": {
          "type": "integer",
        ...
        "quote-request-original-id": {
          "type": "string",
          "description": "Coupa unique identifier for original Sourcing Event",
          "format": "string",
          "readOnly": true
        },
        "quote-request-revision": {
          "type": "string",
          "description": "Sourcing Event Revision",
          "format": "string",
          "readOnly": true
        },
        "quote-supplier": {
    ...
    "QuoteResponseLine": {
      ...
      "properties": {
        ...
        "cost-element-values": {
          "type": "string",
          "description": "Cost element values",
          "format": "text"
        },
        "created-at": {
          "type": "string",
        ...
        "quote-request-line-id": {
          "type": "integer",
          "description": "Quote request line",
          "format": "integer",
          "readOnly": true
        },
        "reporting-price-amount": {
          "type": "number",
          "description": "Reporting price amount",
          "format": "decimal(30,6)",
          "readOnly": true
        },
        "shipping-term": {
    ...
    "QuoteSupplier": {
      ...
      "properties": {
        ...
        "public-profile-link": {
          "type": "string",
          "description": "Quote supplier public profile link",
          "format": "string(255)"
        },
        "supplier": {
          "$ref": "#/definitions/Supplier"
