---
title: "Invoice Line API"
url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-coupa-core-api/resources/transactional-resources/invoices-api-(invoices)/invoice-line-api"
final_url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-coupa-core-api/resources/transactional-resources/invoices-api-(invoices)/invoice-line-api"
status_code: 200
...
This resource is a data type and doesn't have its own endpoint. See [Invoice Header API](https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-coupa-core-api/resources/transactional-resources/invoices-api-(invoices)-da-5926-da-5926) to see what actions are available.
...
| account-allocations | account-allocations | | | | yes | yes | Invoice Line Allocation |
| accounting-total | accounting-total | | | | | yes | decimal(30,3) |
...
| adjustment-type | Adjustment Type | | | price, quantity, other | | yes | string(255) |
...
| classification-of-goods | Classification of Goods | | | | yes | yes | string(8) |
...
| contract | contract | | | | yes | yes | [Contracts](https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-coupa-core-api/resources/transactional-resources/contracts-api-(contracts)) |
...
| failed-tolerances | Failed tolerances | | | | yes | yes | [Failed Tolerance](https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-coupa-core-api/resources/transactional-resources/invoices-api-(invoices)/failed-tolerances-api) |
| fiscal-code | Fiscal Code | | | | yes | yes | string(4) |
...
| item-barcode | Item Barcode | | | | yes | yes | string(14) |
...
| municipality-taxation-code | Municipality Taxation Code | | | | yes | yes | string(255) |
| net-weight | net-weight | | | | yes | yes | decimal(30,6) |
| order-header-num | order-header-num | | | | | yes | |
| order-line-commodity | order-line-commodity | | | | | yes | |
| order-line-custom-fields | order-line-custom-fields | | | | | yes | |
| order-line-id | order-line-id | | | | yes | yes | integer |
| order-line-num | order-line-num | | | | | yes | |
...
| price-per-uom | price-per-uom | | | | yes | yes | decimal(30,6) |
...
| supp-aux-part-num | | | | | | yes | text |
| taggings | Taggings | | | | yes | yes | [Tagging API](https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-coupa-core-api/resources/shared-resources/tagging-api) |
...
| tax-amount | tax-amount | | | | yes | yes | decimal |
| tax-amount-engine | Tax amount calculated by either Coupa Native or External Tax Engine based on configuration | | | | | yes | |
| tax-code | tax-code | | | | yes | yes | Tax Code |
| tax-code-engine | Tax code returned by External Tax Engine based on configuration | | | | | yes | |
| tax-description | tax-description | | | | | yes | |
...
| tax-location | tax-location | | | | | yes | |
| tax-rate | tax-rate | | | | yes | yes | |
| tax-rate-engine | Tax rate returned by External Tax Engine based on configuration | | | | | yes | |
| tax-supply-date | tax-supply-date | | | | | yes | |
| total | total | | | | | yes | decimal(46,20) |
| type | type | | | InvoiceQuantityLine,<br>InvoiceAmountLine | yes | yes | string(100) |
...
| weight-uom | weight-uom | | | | yes | yes | [Uom](https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-coupa-core-api/resources/shared-resources/unit-of-measure-api) |
...
| adjustment-type | Adjustment Type | | | price, quantity, other | yes | yes | string(255) |
| supp-aux-part-num | | | | | yes | yes | text |
| unspsc | UNSPSC | | | | yes | | string(255) |
...
| fiscal-code | BR |
| item-barcode | BR |
| municipality-taxation-code | BR |
| hsn-sac-code | IN |
| company-uom | MX |
| customs-declaration-number | MX |
| discount-amount | MX |
| property-tax-account | MX |
| unspsc | MX |
