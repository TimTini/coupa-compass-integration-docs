---
title: "Inventory Consumptions API (/inventory_consumptions)"
...
final_url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-coupa-core-api/resources/transactional-resources/receipts-api/inventory-consumptions-api-(inventory_consumptions)"
status_code: 200
...
The URL to access inventory
consumptions is: `https:///api/inventory_consumptions`
...
For more information about the Inventory Consumptions API payload, see [Receipts API Example Calls](https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-coupa-core-api/resources/transactional-resources/receipts-api/receipts-api-example-calls).
