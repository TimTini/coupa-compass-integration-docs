---
title: "R39_Coupa_Pay_Base_API.json"
url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/R39/R39_Coupa_Pay_Base_API.json"
final_url: "https://compass.coupa.com/_dita_/en-us/documentation/plat/integ/core_api_and_csv_download_formats/misc/R39/R39_Coupa_Pay_Base_API.json"
content_type: "application/json"
classification: "json_asset"
fetched_at: "2026-04-10T01:56:23+00:00"
---

# R39_Coupa_Pay_Base_API.json
...
```json
{
  ...
  "info": {
    "version": "",
    "title": "Coupa API",
    "description": "RESTful API that provides robust access to read, edit, or integrate your data with the Coupa platform. The [JSON](/api_docs/20.json) and [YAML](/api_docs/20.yaml) are also available.  To test with OAuth2 OAuth2AccessCode, make sure to include https://r39.coupadev.com/oauth2-redirect.html in the client's Redirect URI list"
  },
  "host": "r39.coupadev.com",
  "basePath": "/api",
  "tags": [
    {
      "name": "CoupaPay-Payment",
      "description": "Coupa Pay Payments API"
    }
  ],
  "schemes": [
    "https"
  ...
  "paths": {
    "/coupa_pay/payments/{id}/export": {
      "put": {
        "tags": [
          "CoupaPay-Payment"
        ],
        "summary": "Mark transaction as exported",
        "description": "Mark transaction as exported",
        "consumes": [
          "application/xml",
          "application/json"
        ],
        ...
        "parameters": [
          {
            ...
            "required": false,
            "schema": {
              "$ref": "#/definitions/CoupaPay-Payment"
            }
          },
          {
            "in": "path",
        ...
        "responses": {
          "200": {
            "description": "CoupaPay-Payment object",
            "schema": {
              "items": {
                "$ref": "#/definitions/CoupaPay-Payment"
              }
    ...
    "/coupa_pay/payments": {
      "get": {
        ...
        "responses": {
          "200": {
            "description": "CoupaPay-Payment objects",
            "schema": {
              "type": "array",
              "items": {
                "$ref": "#/definitions/CoupaPay-Payment"
  ...
  "securityDefinitions": {
    "OAuth2ClientCredential": {
      ...
      "scopes": {
        "core.pay.payments.read": "Allows Coupa Pay payments to be read",
        "core.pay.payments.write": "Allows Coupa Pay payments to be modified"
      }
    },
    "OAuth2AccessCode": {
      "type": "oauth2",
  ...
  "definitions": {
    ...
    "CoupaPay-CompanyPaymentAccount": {
      "type": "object",
      "properties": {
        "account-kind": {
          "type": "string",
        ...
        "digital-check-signature-viewpost-status": {
          "type": "string",
          "description": "Digital check signature viewpost status",
          "format": "string(255)",
          "enum": [
            "not_used",
            "send_pending",
        ...
        "physical-check-signature-presence": {
          "type": "boolean",
          "description": "Physical check signature presence",
          "format": "boolean"
        },
        "source-name": {
          "type": "string",
        ...
        "supported-transfer-types": {
          "type": "string",
          "description": "Supported transfer types",
          "format": "[]",
          "readOnly": true
        },
        "updated-at": {
    ...
    "CoupaPay-DigitalCheck": {
      "type": "object",
      "properties": {
        "beneficary-name": {
          "type": "string",
          "description": "Beneficary name"
        },
        "check-number": {
          "type": "integer",
    ...
    "CoupaPay-EmployeePaymentAccountSerializer": {
      "type": "object"
    },
    "CoupaPay-Payment": {
      "type": "object",
      "properties": {
        ...
        "digital-check": {
          "$ref": "#/definitions/CoupaPay-DigitalCheck"
        },
        "error-text": {
          "type": "string",
          "description": "Information if a payment error occurs",
          "format": "string(255)",
          "readOnly": true
        },
        "estimated-pay-from-total": {
          "type": "number",
          "description": "The estimated amount in the funding currency",
          "format": "decimal",
          "readOnly": true
        },
        "exchange-rate": {
          "type": "number",
          "description": "Exchange Rate used for conversion of pay from to pay to",
          "format": "decimal(30,9)",
          "readOnly": true
        },
        "exported": {
        ...
        "line-num": {
          "type": "integer",
          "description": "Line Number of batch",
          "format": "integer",
          "readOnly": true
        },
        "pay-from-account": {
          "$ref": "#/definitions/CoupaPay-CompanyPaymentAccount"
        },
        "pay-from-currency": {
          "$ref": "#/definitions/Currency"
        },
        "pay-from-external-gl-account": {
          "$ref": "#/definitions/ExternalGlAccount"
        },
        "pay-from-total": {
          "type": "number",
          "description": "The amount of funding currency",
          "format": "decimal",
          "readOnly": true
        },
        "pay-to-account": {
        ...
        "pay-to-total": {
          "type": "number",
          "description": "The amount of transmitted currency",
          "format": "decimal",
          "readOnly": true
        },
        "payee": {
          "description": "Entity receiving the payment. Can be one of multiple objects: CoupaPay::EmployeePaymentAccountSerializer, CoupaPay::SupplierPaymentAccountSerializer, UserSimpleSerializer, SupplierSimpleSerializer",
          "readOnly": true
        },
        "payment-batch": {
          "$ref": "#/definitions/CoupaPay-PaymentBatch"
        },
        "payment-batch-id": {
          "type": "integer",
          "description": "This payments Batch ID",
          "format": "integer",
          "readOnly": true
        },
        "payment-details": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/CoupaPay-PaymentDetail"
          }
        },
        "payment-identifier": {
          "type": "string",
        ...
        "released-at": {
          "type": "string",
          "description": "Date and time transaction was release in the format YYYY-MM-DDTHH:MM:SS+HH:MMZ",
          "format": "datetime",
          "readOnly": true
        },
        "reporting-currency": {
        ...
        "reporting-pay-from-total": {
          "type": "number",
          "description": "The amount of funding currency in the reporting total",
          "format": "decimal",
          "readOnly": true
        },
        "reporting-pay-to-total": {
          "type": "number",
          "description": "The amount of transmitted currency in the reporting total",
          "format": "decimal",
          "readOnly": true
        },
        "requested-execution-date": {
          "type": "string",
          "description": "Requested Execution Date can be used to request the bank to initiate a payment on a specific date",
          "format": "date",
          "readOnly": true
        },
        "source-name": {
        ...
        "source-reference": {
          "type": "string",
          "description": "Unique reference number from source system",
          "format": "string(255)",
          "readOnly": true
        },
        "status": {
        ...
        "transfer-type": {
          "type": "string",
          "description": "Transfer Type for the Payment",
          "format": "string(255)",
          "readOnly": true
        },
        "type": {
    ...
    "CoupaPay-PaymentDetail": {
      ...
      "properties": {
        ...
        "payable-document-type": {
          "type": "string",
          "description": "Payable document type",
          "readOnly": true
        },
        "payable-id": {
          "type": "integer",
    ...
    "CoupaPay-SupplierPaymentAccountSerializer": {
      "type": "object"
    },
    "Currency": {
      "type": "object",
