---
title: "Supplier Site Import"
url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/coupa-core-flat-files-(csv)/flat-file-(csv)-import/supplier-site-import"
final_url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/coupa-core-flat-files-(csv)/flat-file-(csv)-import/supplier-site-import"
status_code: 200
...
.`/Incoming/SupplierSites/` in the standard SFTP setup.
These files are moved to the archive folder located at
`./Incoming/Archive/SupplierSites/` before being
...
| Address Location Codes | No | No | | List of associated Supplier address location codes. Must belong to a parent supplier | |
| Address Remit To Codes | No | No | | List of associated Supplier address remit to codes. Must belong to a parent supplier | |
