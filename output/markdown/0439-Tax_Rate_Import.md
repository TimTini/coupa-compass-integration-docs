---
title: "Tax Rate Import"
url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/coupa-core-flat-files-(csv)/flat-file-(csv)-import/tax-rate-import"
final_url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/coupa-core-flat-files-(csv)/flat-file-(csv)-import/tax-rate-import"
status_code: 200
...
the `./Incoming/TaxRates/` in the SFTP. These
files will be moved to the archive folder located
at `./Incoming/Archive/TaxRates/` before being
...
You can update any field if you specify Tax Rate
Id. If there is no Tax Rate Id, then Coupa uses the
combination of Country Code, Tax Rate Type and Percentage to
