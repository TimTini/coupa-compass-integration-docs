...
final_url: "https://compass.coupa.com/en-us/products/product-documentation/integration-technical-documentation/the-cso-api/user-api"
status_code: 200
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| id | ID of the user | | Yes | | | yes | integer |
| state | Status of the user | | | Blocked, Active, Disabled, Removed (Case-Sensitive) | yes | yes | string |
...
| invoicing_user | Invoicing User | | | any | yes | | boolean |
...
In this example, we queried for a User
API. We did a GET to the
URL:
...
you can use the Coupa API to perform actions on User.
...
successful. User ID is required for updates.

Successful requests will return
`HTTP 200 Response`. The body of the response will include the created
